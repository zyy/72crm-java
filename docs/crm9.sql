...
-- ----------------------------
INSERT INTO `72crm_admin_config` VALUES ('3', '1', 'customerPoolSetting', '', '客户公海规则设置');
INSERT INTO `72crm_admin_config` VALUES ('4', '1', 'expiringContractDays', '3', '合同到期提醒');
INSERT INTO `72crm_admin_config` VALUES ('5', '0', 'customerPoolSettingDealDays', '3', '客户公海规则设置未成交天数');
INSERT INTO `72crm_admin_config` VALUES ('6', '0', 'customerPoolSettingFollowupDays', '31', '客户公海规则设置未跟进天数');
...
CREATE TABLE `72crm_crm_customer` (
  ...
  `followup` int(11) NOT NULL DEFAULT '0' COMMENT '跟进状态 0未跟进1已跟进',
...
) ENGINE=InnoDB AUTO_INCREMENT=5206 DEFAULT CHARSET=utf8 COMMENT='客户表';
...
CREATE SQL SECURITY DEFINER VIEW `businessview` AS select `a`.`business_id` AS `business_id`,`a`.`type_id` AS `type_id`,`a`.`status_id` AS `status_id`,`a`.`next_time` AS `next_time`,`a`.`customer_id` AS `customer_id`,`a`.`deal_date` AS `deal_date`,`a`.`business_name` AS `business_name`,`a`.`money` AS `money`,`a`.`discount_rate` AS `discount_rate`,`a`.`remark` AS `remark`,`a`.`create_user_id` AS `create_user_id`,`a`.`owner_user_id` AS `owner_user_id`,`a`.`create_time` AS `create_time`,`a`.`update_time` AS `update_time`,`a`.`batch_id` AS `batch_id`,`a`.`ro_user_id` AS `ro_user_id`,`a`.`rw_user_id` AS `rw_user_id`,`a`.`is_end` AS `is_end`,`a`.`status_remark` AS `status_remark`,`b`.`realname` AS `create_user_name`,`c`.`realname` AS `owner_user_name`,`d`.`customer_name` AS `customer_name`,`e`.`name` AS `type_name`,`f`.`name` AS `status_name`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '单行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `单行文本` from (((((`72crm_crm_business` `a` left join `72crm_admin_user` `b` on((`a`.`create_user_id` = `b`.`user_id`))) left join `72crm_admin_user` `c` on((`a`.`owner_user_id` = `c`.`user_id`))) left join `72crm_crm_customer` `d` on((`a`.`customer_id` = `d`.`customer_id`))) left join `72crm_crm_business_type` `e` on((`a`.`type_id` = `e`.`type_id`))) left join `72crm_crm_business_status` `f` on((`a`.`status_id` = `f`.`status_id`))) ;

-- ----------------------------
-- View structure for contactsview
-- ----------------------------
DROP VIEW IF EXISTS `contactsview`;
CREATE SQL SECURITY DEFINER VIEW `contactsview` AS select `a`.`contacts_id` AS `contacts_id`,`a`.`name` AS `name`,`a`.`next_time` AS `next_time`,`a`.`mobile` AS `mobile`,`a`.`telephone` AS `telephone`,`a`.`email` AS `email`,`a`.`post` AS `post`,`a`.`customer_id` AS `customer_id`,`a`.`address` AS `address`,`a`.`remark` AS `remark`,`a`.`create_user_id` AS `create_user_id`,`a`.`owner_user_id` AS `owner_user_id`,`a`.`create_time` AS `create_time`,`a`.`update_time` AS `update_time`,`a`.`batch_id` AS `batch_id`,`a`.`name` AS `contacts_name`,`b`.`realname` AS `create_user_name`,`c`.`realname` AS `owner_user_name`,`d`.`customer_name` AS `customer_name`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '是否关键决策人') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `是否关键决策人`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '性别') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `性别`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多选') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多选`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多行文本`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '下拉框') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `下拉框` from (((`72crm_crm_contacts` `a` left join `72crm_admin_user` `b` on((`a`.`create_user_id` = `b`.`user_id`))) left join `72crm_admin_user` `c` on((`a`.`owner_user_id` = `c`.`user_id`))) left join `72crm_crm_customer` `d` on((`a`.`customer_id` = `d`.`customer_id`))) ;

-- ----------------------------
-- View structure for contractview
-- ----------------------------
DROP VIEW IF EXISTS `contractview`;
CREATE SQL SECURITY DEFINER VIEW `contractview` AS select `a`.`contract_id` AS `contract_id`,`a`.`name` AS `name`,`a`.`customer_id` AS `customer_id`,`a`.`business_id` AS `business_id`,`a`.`check_status` AS `check_status`,`a`.`examine_record_id` AS `examine_record_id`,`a`.`order_date` AS `order_date`,`a`.`create_user_id` AS `create_user_id`,`a`.`owner_user_id` AS `owner_user_id`,`a`.`create_time` AS `create_time`,`a`.`update_time` AS `update_time`,`a`.`num` AS `num`,`a`.`start_time` AS `start_time`,`a`.`end_time` AS `end_time`,`a`.`money` AS `money`,`a`.`discount_rate` AS `discount_rate`,`a`.`types` AS `types`,`a`.`payment_type` AS `payment_type`,`a`.`batch_id` AS `batch_id`,`a`.`ro_user_id` AS `ro_user_id`,`a`.`rw_user_id` AS `rw_user_id`,`a`.`contacts_id` AS `contacts_id`,`a`.`remark` AS `remark`,`a`.`company_user_id` AS `company_user_id`,`b`.`realname` AS `create_user_name`,`c`.`realname` AS `owner_user_name`,`d`.`customer_name` AS `customer_name`,`e`.`business_name` AS `business_name`,`f`.`name` AS `contacts_name`,`g`.`realname` AS `company_user_name`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '单行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `单行文本`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '手机') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `手机`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '日期') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `日期`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '日期时间') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `日期时间`,(select `72crm_admin_dept`.`name` from `72crm_admin_dept` where (`72crm_admin_dept`.`dept_id` = (select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '部门') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1))) AS `部门` from ((((((`72crm_crm_contract` `a` left join `72crm_admin_user` `b` on((`a`.`create_user_id` = `b`.`user_id`))) left join `72crm_admin_user` `c` on((`a`.`owner_user_id` = `c`.`user_id`))) left join `72crm_crm_customer` `d` on((`a`.`customer_id` = `d`.`customer_id`))) left join `72crm_crm_business` `e` on((`a`.`business_id` = `e`.`business_id`))) left join `72crm_crm_contacts` `f` on((`a`.`contacts_id` = `f`.`contacts_id`))) left join `72crm_admin_user` `g` on((`a`.`company_user_id` = `g`.`user_id`))) ;
...
CREATE SQL SECURITY DEFINER VIEW `leadsview` AS select `a`.`leads_id` AS `leads_id`,`a`.`followup` AS `followup`,`a`.`is_transform` AS `is_transform`,`a`.`leads_name` AS `leads_name`,`a`.`customer_id` AS `customer_id`,`a`.`next_time` AS `next_time`,`a`.`telephone` AS `telephone`,`a`.`mobile` AS `mobile`,`a`.`address` AS `address`,`a`.`remark` AS `remark`,`a`.`create_user_id` AS `create_user_id`,`a`.`owner_user_id` AS `owner_user_id`,`a`.`create_time` AS `create_time`,`a`.`update_time` AS `update_time`,`a`.`batch_id` AS `batch_id`,`b`.`realname` AS `create_user_name`,`c`.`realname` AS `owner_user_name`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '线索来源') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `线索来源`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '客户行业') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `客户行业`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '客户级别') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `客户级别`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '附件') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `附件`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '邮箱') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `邮箱`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '货币') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `货币`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多选') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多选`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多行文本`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '单行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `单行文本` from ((`72crm_crm_leads` `a` left join `72crm_admin_user` `b` on((`a`.`create_user_id` = `b`.`user_id`))) left join `72crm_admin_user` `c` on((`a`.`owner_user_id` = `c`.`user_id`))) ;

-- ----------------------------
-- View structure for productview
-- ----------------------------
DROP VIEW IF EXISTS `productview`;
CREATE SQL SECURITY DEFINER VIEW `productview` AS select `a`.`product_id` AS `product_id`,`a`.`name` AS `name`,`a`.`num` AS `num`,`a`.`unit` AS `unit`,`a`.`price` AS `price`,`a`.`status` AS `status`,`a`.`category_id` AS `category_id`,`a`.`description` AS `description`,`a`.`create_user_id` AS `create_user_id`,`a`.`owner_user_id` AS `owner_user_id`,`a`.`create_time` AS `create_time`,`a`.`update_time` AS `update_time`,`a`.`batch_id` AS `batch_id`,`b`.`realname` AS `create_user_name`,`c`.`realname` AS `owner_user_name`,`d`.`name` AS `category_name`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '是否上下架') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `是否上下架`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '单位') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `单位`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多行文本') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多行文本`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '手机111') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `手机111`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '货币1111') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `货币1111`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '多选111') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `多选111`,(select `72crm_admin_field`.`value` from `72crm_admin_field` where ((`72crm_admin_field`.`name` = '产品颜色') and (`72crm_admin_field`.`batch_id` = convert(`a`.`batch_id` using utf8mb4))) limit 1) AS `产品颜色` from (((`72crm_crm_product` `a` left join `72crm_admin_user` `b` on((`a`.`create_user_id` = `b`.`user_id`))) left join `72crm_admin_user` `c` on((`a`.`owner_user_id` = `c`.`user_id`))) left join `72crm_crm_product_category` `d` on((`a`.`category_id` = `d`.`category_id`))) ;
